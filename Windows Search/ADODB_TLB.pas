...
// $Rev: 17252 $
// Datei am 17.02.2009 10:22:05 erzeugt aus der unten beschriebenen Typbibliothek.

// ************************************************************************  //
// Typbib.: C:\Program Files\Common Files\System\ado\msado28.tlb (1)
// LIBID: {2A75196C-D9EB-4129-B803-931327F72D5C}
// LCID: 0
// Hilfedatei: C:\Windows\HELP\ado270.chm
// Hilfe-String: Microsoft ActiveX Data Objects 2.8 Library
// Liste der Abhäng.: 
//   (1) v2.0 stdole, (C:\Windows\system32\stdole2.tlb)
// Fehler//   Hinweis: Property geändert zu Property_
//   Hinweis: Record geändert zu Record_
//   Hinweis: Parameter 'Object' im _DynaCollection.Append geändert zu 'Object_'
//   Hinweis: Symbol 'Type' umbenannt in 'type_'
//   Hinweis: Parameter 'Type' im Command15.CreateParameter geändert zu 'Type_'
//   Hinweis: Parameter 'Type' im Fields.Append geändert zu 'Type_'
//   Hinweis: Parameter 'Type' im Fields20._Append geändert zu 'Type_'
//   Hinweis: Symbol 'Type' umbenannt in 'type_'
//   Hinweis: Symbol 'Type' umbenannt in 'type_'
//   Hinweis: Symbol 'Type' umbenannt in 'type_'
//   Hinweis: Symbol 'Type' umbenannt in 'type_'
...
// *********************************************************************//
const
  // Haupt- und Nebenversionen der Typbibliothek  ADODBMajorVersion = 2;
  ADODBMinorVersion = 8;
...
// Konstanten für enum CursorTypeEnum
type
...
// Konstanten für enum CursorOptionEnum
type
...
// Konstanten für enum ConnectOptionEnum
type
...
// Konstanten für enum ObjectStateEnum
type
...
// Konstanten für enum DataTypeEnum
type
...
// Konstanten für enum FieldAttributeEnum
type
...
// Konstanten für enum EditModeEnum
type
...
// Konstanten für enum RecordStatusEnum
type
...
// Konstanten für enum GetRowsOptionEnum
type
  GetRowsOptionEnum = TOleEnum;
const
  adGetRowsRest = $FFFFFFFF;

// Konstanten für enum PositionEnum
type
...
// Konstanten für enum BookmarkEnum
type
...
// Konstanten für enum MarshalOptionsEnum
type
...
// Konstanten für enum AffectEnum
type
  AffectEnum = TOleEnum;
const
...
// Konstanten für enum ResyncEnum
type
  ResyncEnum = TOleEnum;
const
...
// Konstanten für enum CompareEnum
type
...
// Konstanten für enum FilterGroupEnum
type
...
// Konstanten für enum SearchDirectionEnum
type
...
// Konstanten für enum PersistFormatEnum
type
...
// Konstanten für enum StringFormatEnum
type
  StringFormatEnum = TOleEnum;
const
  adClipString = $00000002;

// Konstanten für enum ConnectPromptEnum
type
...
// Konstanten für enum ConnectModeEnum
type
...
// Konstanten für enum RecordCreateOptionsEnum
type
...
// Konstanten für enum RecordOpenOptionsEnum
type
...
// Konstanten für enum IsolationLevelEnum
type
...
// Konstanten für enum XactAttributeEnum
type
...
// Konstanten für enum PropertyAttributesEnum
type
...
// Konstanten für enum ErrorValueEnum
type
...
// Konstanten für enum ParameterAttributesEnum
type
...
// Konstanten für enum ParameterDirectionEnum
type
...
// Konstanten für enum EventStatusEnum
type
...
// Konstanten für enum EventReasonEnum
type
...
// Konstanten für enum SchemaEnum
type
  SchemaEnum = TOleEnum;
const
...
// Konstanten für enum FieldStatusEnum
type
...
// Konstanten für enum ADCPROP_ASYNCTHREADPRIORITY_ENUM
type
...
// Konstanten für enum ADCPROP_AUTORECALC_ENUM
type
...
// Konstanten für enum ADCPROP_UPDATERESYNC_ENUM
type
...
// Konstanten für enum MoveRecordOptionsEnum
type
...
// Konstanten für enum CopyRecordOptionsEnum
type
...
// Konstanten für enum StreamTypeEnum
type
...
// Konstanten für enum LineSeparatorEnum
type
...
// Konstanten für enum StreamOpenOptionsEnum
type
...
// Konstanten für enum StreamWriteEnum
type
...
// Konstanten für enum SaveOptionsEnum
type
...
// Konstanten für enum StreamReadEnum
type
...
// Konstanten für enum RecordTypeEnum
type
...
// Verfügung, um Instanzen des Standard-Interface _Connection, dargestellt 
// von CoClass Connection, zu erzeugen. Diese Funktionen können                     
...
// *********************************************************************//
// Die Klasse CoRecord_ stellt die Methoden Create und CreateRemote zur      
// Verfügung, um Instanzen des Standard-Interface _Record, dargestellt 
// von CoClass Record_, zu erzeugen. Diese Funktionen können                     
// von einem Client verwendet werden, der die CoClasses automatisieren    
// will, die von dieser Typbibliothek dargestellt werden.                                            
// *********************************************************************//
...
// *********************************************************************//
// Die Klasse CoStream stellt die Methoden Create und CreateRemote zur      
// Verfügung, um Instanzen des Standard-Interface _Stream, dargestellt 
// von CoClass Stream, zu erzeugen. Diese Funktionen können                     
// von einem Client verwendet werden, der die CoClasses automatisieren    
// will, die von dieser Typbibliothek dargestellt werden.                                            
// *********************************************************************//
...
// *********************************************************************//
// Die Klasse CoCommand stellt die Methoden Create und CreateRemote zur      
// Verfügung, um Instanzen des Standard-Interface _Command, dargestellt 
// von CoClass Command, zu erzeugen. Diese Funktionen können                     
// von einem Client verwendet werden, der die CoClasses automatisieren    
// will, die von dieser Typbibliothek dargestellt werden.                                            
// *********************************************************************//
...
// *********************************************************************//
// Die Klasse CoRecordset stellt die Methoden Create und CreateRemote zur      
// Verfügung, um Instanzen des Standard-Interface _Recordset, dargestellt 
// von CoClass Recordset, zu erzeugen. Diese Funktionen können                     
// von einem Client verwendet werden, der die CoClasses automatisieren    
// will, die von dieser Typbibliothek dargestellt werden.                                            
// *********************************************************************//
...
// *********************************************************************//
// Die Klasse CoParameter stellt die Methoden Create und CreateRemote zur      
// Verfügung, um Instanzen des Standard-Interface _Parameter, dargestellt 
// von CoClass Parameter, zu erzeugen. Diese Funktionen können                     
// von einem Client verwendet werden, der die CoClasses automatisieren    
// will, die von dieser Typbibliothek dargestellt werden.                                            
// *********************************************************************//
